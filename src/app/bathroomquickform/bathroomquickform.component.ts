...
@Component({
  selector: 'app-bathroomquickform',
  templateUrl: './bathroomquickform.component.html',
  styleUrls: ['./bathroomquickform.component.css']
})
export class BathroomquickformComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/bathroomquick";
  bookingRequest()
  {
