...
@Component({
  selector: 'app-maidcorporate',
  templateUrl: './maidcorporate.component.html',
  styleUrls: ['./maidcorporate.component.css']
})
export class MaidcorporateComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/maidcorporate";
  bookingRequest()
  {
