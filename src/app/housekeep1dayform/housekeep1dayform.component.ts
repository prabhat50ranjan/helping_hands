...
@Component({
  selector: 'app-housekeep1dayform',
  templateUrl: './housekeep1dayform.component.html',
  styleUrls: ['./housekeep1dayform.component.css']
})
export class Housekeep1dayformComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/housekeep1day";
  bookingRequest()
  {
