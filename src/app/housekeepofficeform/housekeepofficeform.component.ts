...
@Component({
  selector: 'app-housekeepofficeform',
  templateUrl: './housekeepofficeform.component.html',
  styleUrls: ['./housekeepofficeform.component.css']
})
export class HousekeepofficeformComponent {
  ...
  url="https://helpinghands90.herokuapp.com/housekeepoffice";
  bookingRequest()
  {
