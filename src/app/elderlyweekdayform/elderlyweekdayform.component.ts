...
@Component({
  selector: 'app-elderlyweekdayform',
  templateUrl: './elderlyweekdayform.component.html',
  styleUrls: ['./elderlyweekdayform.component.css']
})
export class ElderlyweekdayformComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/elderlyweekday";
  bookingRequest()
  {
