...
@Component({
  selector: 'app-housekeephomeform',
  templateUrl: './housekeephomeform.component.html',
  styleUrls: ['./housekeephomeform.component.css']
})
export class HousekeephomeformComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/housekeephome";
  bookingRequest()
  {
