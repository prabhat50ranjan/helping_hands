...
@Component({
  selector: 'app-cook1dayform',
  templateUrl: './cook1dayform.component.html',
  styleUrls: ['./cook1dayform.component.css']
})
export class Cook1dayformComponent  {
  ...
  url="https://helpinghands90.herokuapp.com/cook1day";
  bookingRequest()
  {
