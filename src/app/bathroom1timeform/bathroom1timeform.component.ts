...
@Component({
  selector: 'app-bathroom1timeform',
  templateUrl: './bathroom1timeform.component.html',
  styleUrls: ['./bathroom1timeform.component.css']
})
export class Bathroom1timeformComponent {
  ...
  url="https://helpinghands90.herokuapp.com/bathroom1time";
  bookingRequest()
  {
